...
import 'package:fitness_track/Screens/Salary/view/salary_details_view.dart';
...
class SalaryListView extends StatefulWidget {
  const SalaryListView({Key? key}) : super(key: key);
...
class _SalaryListViewState extends State<SalaryListView> {
  ...
  SalaryController controller = Get.put(SalaryController());
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Obx(() => !controller.isLoading.value
            ? (controller.salaryList ?? []).isNotEmpty
                ? ListView.builder(
                      ...
                      child: InkWell(
                        onTap: () {
                          controller.selectedSalary.value =
                              controller.salaryList[index];
                          Get.to(SalaryDetailsView());
                        },
                        child: Card(
                          elevation: 2.0,
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Text(
                                        getDateOnly((controller.salaryList
                                                    .value[index].endDate ??
                                                DateTime(2023))
                                            .toString()),
                                        style: TextStyle(
