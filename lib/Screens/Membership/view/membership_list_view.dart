...
class MembershipListView extends StatefulWidget {
  const MembershipListView({Key? key}) : super(key: key);

  @override
  State<MembershipListView> createState() => _MembershipListViewState();
}
...
class _MembershipListViewState extends State<MembershipListView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async{
      ...
      controller.getMembershipListAPI();
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Obx(() =>!controller.isLoading.value?controller.membershipList.isNotEmpty?Padding(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text(
                            "Start Date : ",
                            style: TextStyle(color: hint_txt_909196,
