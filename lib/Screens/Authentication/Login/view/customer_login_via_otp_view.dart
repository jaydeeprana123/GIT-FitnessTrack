...
class CustomerLoginViaOTPView extends StatefulWidget {
  const CustomerLoginViaOTPView({Key? key}) : super(key: key);

  @override
  State<CustomerLoginViaOTPView> createState() => _CustomerLoginViaOTPViewState();
}

class _CustomerLoginViaOTPViewState extends State<CustomerLoginViaOTPView> {
  /// Initialize the controller
  CustomerLoginController controller = Get.put(CustomerLoginController());
                  ...
                  Padding(
                    ...
                    child: CommonWhiteButton("Send OTP", () {
                      ...
                      checkNet(context).then((value) {
                        controller.callSendOTPAPI(context);
                      });
                    },
