            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text("From : " +
                        (getDateOnly((controller.selectedWorkoutData.value
                            .workoutDate ??
                            DateTime(2023))
                            .toString())) +
                            "  To : " +
                            (getDateOnly((controller
                                .selectedWorkoutData.value.dueDate ??
                                DateTime(2023))
                                .toString())),
                        style: TextStyle(
                            color: text_color,
                ...
                Text(
                    "Duration : ${controller.selectedWorkoutData.value.durationInDays ??
                        "0"}",
                    style: TextStyle(
                        color: text_color,
                        fontSize: 14,
                ...
                Row(
                  children: [
                    ...
                    Expanded( flex: 1,child: Text(
                        "SETS", textAlign: TextAlign.center,
                        style: TextStyle(
                            color: text_color,
                            fontSize: 13,
                            fontFamily: fontInterSemiBold)),),
                    Expanded( flex: 1,child:   Text(
                        "REP", textAlign: TextAlign.center,
                        style: TextStyle(
                            color: text_color,
                            fontSize: 13,
                            fontFamily: fontInterSemiBold)),),
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Expanded(flex: 3,
                                  child: Text(
                                      controller.selectedWorkoutData.value.warmupList?[index].masterWorkoutName??"",
                                      style: TextStyle(
                                          color: text_color,
                                          fontSize: 13,
                                          fontFamily: fontInterRegular)),
                                ...
                                Expanded(flex: 1,
                                  child: Text(
                                      controller.selectedWorkoutData.value.warmupList?[index].sets??"",
                                ...
                                Expanded(flex: 1,
                                  child: Text(
                                      controller.selectedWorkoutData.value.warmupList?[index].repeatNo??"",
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                          color: text_color,
                                          fontSize: 13,
                                ...
                                Expanded(flex: 1,
                                  child: Text(
                                      controller.selectedWorkoutData.value.warmupList?[index].repeatTime??"",
                                      textAlign: TextAlign.center
                                      ,style: TextStyle(
                                          color: text_color,
                                          fontSize: 13,
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                                "Day " + (controller.selectedWorkoutData.value.workoutTrainingList?[index].day??""),
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    color: text_color,
                                    fontSize: 14,
                            ...
                            ListView.builder(
                              ...
                              primary: false,
                              shrinkWrap: true,
                              itemCount: (controller.selectedWorkoutData.value.workoutTrainingList?[index].workoutTrainingCategory??[]).length,
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        SizedBox(height: 6,),
                                        Text(
                                            controller.selectedWorkoutData.value.workoutTrainingList?[index].workoutTrainingCategory?[j].workoutTrainingCategoryName??"",
                                            style: TextStyle(
                                                color: Colors.red,
                                                fontSize: 15,
                                                fontFamily: fontInterSemiBold)),
                                        ...
                                        ListView.builder(
                                          ...
                                          primary: false,
                                          shrinkWrap: true,
                                          itemCount: (controller.selectedWorkoutData.value.workoutTrainingList?[index].workoutTrainingCategory?[j].workoutTrainingSubCategory??[]).length,
                                          itemBuilder: (context, z) => Container(
                                            margin: EdgeInsets.only( top: 8),
                                            // decoration: BoxDecoration(
                                            //     borderRadius: BorderRadius.circular(12),
                                            //     color: color_primary,
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      children: [
                                                        Expanded(flex: 3,
                                                          child: Text(
                                                              controller.selectedWorkoutData.value.workoutTrainingList?[index].workoutTrainingCategory?[j].workoutTrainingSubCategory?[z].workoutDetailName??"",
                                                              style: TextStyle(
                                                                  color: text_color,
                                                                  fontSize: 13,
                                                                  fontFamily: fontInterRegular)),
                                                        ...
                                                        Expanded(flex: 1,
                                                          child: Text(
                                                              controller.selectedWorkoutData.value.workoutTrainingList?[index].workoutTrainingCategory?[j].workoutTrainingSubCategory?[z].sets??"",
                                                              textAlign: TextAlign.center,
                                                              style: TextStyle(
                                                                  color: text_color,
                                                                  fontSize: 13,
                                                        ...
                                                        Expanded(flex: 1,
                                                          child: Text(
                                                              controller.selectedWorkoutData.value.workoutTrainingList?[index].workoutTrainingCategory?[j].workoutTrainingSubCategory?[z].repeatNo??"",
                                                              textAlign: TextAlign.center,
                                                              style: TextStyle(
                                                                  color: text_color,
                                                                  fontSize: 13,
                                                        ...
                                                        Expanded(flex: 1,
                                                          child: Text(
                                                              controller.selectedWorkoutData.value.workoutTrainingList?[index].workoutTrainingCategory?[j].workoutTrainingSubCategory?[z].repeatTime??"",
                                                              textAlign: TextAlign.center
                                                              ,style: TextStyle(
                                                              color: text_color,
                                                              fontSize: 13,
