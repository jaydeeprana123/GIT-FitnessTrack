...
class _EditAppointmentViewState extends State<EditAppointmentView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async{
      ...
      controller.dateEditingController.value.text = controller.selectedAppointmentData.value.date??"";
      controller.timeksEditingController.value.text = controller.selectedAppointmentData.value.time??"";
      controller.remarksEditingController.value.text = controller.selectedAppointmentData.value.remarks??"";
                  ...
                  children: [
                    ...
                    Center(
                      child: Padding(
                        ...
                        child: CommonGreenButton("UPDATE", () {
                          FocusScope.of(context).unfocus();
                          ...
                          checkNet(context).then((value) {
                            controller.callUpdateAppointmentAPI(context);
                          });
                        }, button_Color),
                      ),
                    ),
