...
class BranchWiseAttendanceListView extends StatefulWidget {

  String? branchId;
  String? branchName;

   BranchWiseAttendanceListView({Key? key, required this.branchId, required this.branchName}) : super(key: key);

  @override
  State<BranchWiseAttendanceListView> createState() => _BranchWiseAttendanceListViewState();
}

class _BranchWiseAttendanceListViewState extends State<BranchWiseAttendanceListView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async{
      ...
      controller.getBranchWiseAttendanceListAPI(widget.branchId??"0");
      ...
      child: Scaffold(
              ...
              Visibility(
                ...
                child: InkWell(
                  onTap: () async {
                    ...
                    controller.fromDateEditingController.value.text = todayDate;
        ...
        body: Obx(() =>Column(
          children: [
              ...
              child: Row(
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      controller
                          .getBranchWiseAttendanceListAPI(widget.branchId??"0");
                    },
                    child: Container(
                      alignment: Alignment.center,
            ...
            Expanded(child: !controller.isLoading.value?(controller.employeeAttendanceList??[]).isNotEmpty?Container(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              SvgPicture.asset(
                                icon_employee, height: 20, width: 20,color: color_primary,),
                              SizedBox(width: 6,),
