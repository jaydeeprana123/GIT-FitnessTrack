...
import '../model/leave_category_list_model.dart';
import '../model/leave_list_model.dart';

class EditLeaveView extends StatefulWidget {
  String? favouriteId;

  EditLeaveView({Key? key, this.favouriteId}) : super(key: key);

  @override
  State<EditLeaveView> createState() => _EditLeaveViewState();
}

class _EditLeaveViewState extends State<EditLeaveView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      await controller.getLeaveCategoryListAPI();

      strLeaveCategoryId =
          controller.selectedLeaveData.value.leaveCategoryId ?? "";
      controller.leaveRequestDataList.value = [];
      for (int i = 0;
          i < (controller.selectedLeaveData.value.leaveDataList ?? []).length;
          i++) {
        LeaveRequestData leaveRequestData = LeaveRequestData();
        leaveRequestData.id = controller.selectedLeaveData.value.leaveDataList?[i].id ?? "";
        leaveRequestData.branchId =
            controller.selectedLeaveData.value.branchId ?? "";
        leaveRequestData.shiftId =
            controller.selectedLeaveData.value.leaveDataList?[i].shiftId ?? "";
        leaveRequestData.shiftName =
            controller.selectedLeaveData.value.leaveDataList?[i].shiftName ??
                "";
        leaveRequestData.leaveDate = getDateFormtYYYYMMDDOnly(
            (controller.selectedLeaveData.value.leaveDataList?[i].leaveDate ??
                    DateTime(2024))
                .toString());
      ...
      //   await controller.getShiftListAPI(context, 0);
      //
      //   for (int i = 1; i < (controller.leaveRequestDataList).length; i++) {
      //     controller.leaveRequestDataList[i].shiftDataList =
      //         controller.leaveRequestDataList[0].shiftDataList;
      //   }
      // } else {
      //   await shiftController.getBranchListAPI(context);
      // }


      controller.leaveRequestDataList[0].branchId =
          controller.loginResponseModel.value.data?[0].branchId ?? "0";
      await controller.getShiftListAPI(0);
      ...
      controller.remarksEditingController.value.text =
          controller.selectedLeaveData.value.remarks ?? "";
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border:
                                      Border.all(color: text_color, width: 0.5),
                                ),
                          ...
                          InkWell(
                            onTap: () {
                              ...
                              if ((controller.loginResponseModel.value.data?[0]
                                      ...
                                      "")
                                  .isNotEmpty) {
                                leaveData.branchId = controller
                                        .loginResponseModel
                                        .value
                                        .data?[0]
                                        .branchId ??
                                    "";
                                leaveData.shiftDataList = controller
                                    .allLeaveShiftDataList;
                              }
                          ...
                          for (int i = 0;
                              i < controller.leaveRequestDataList.length;
                              i++)
                            Container(
                              margin: EdgeInsets.only(top: 16),
                              child: Card(
                                      ...
                                      Align(
                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            ...
                                            if((controller.leaveRequestDataList[i].id??"").isNotEmpty){
                                              controller.callDeleteDateLeaveAPI(controller.leaveRequestDataList[i].id??"", i);
                                            }else{
                          ...
                          Container(
                            decoration: BoxDecoration(
                              borderRadius:
                                  BorderRadius.all(Radius.circular(11.r)),
                              border:
                                  Border.all(width: 1, color: line_gray_e2e2e6),
                            ),
                            child: Padding(
                            ...
                            child: Padding(
                              ...
                              child: CommonGreenButton("SUBMIT", () {
                                ...
                                for (int i = 0;
                                  ...
                                  if (!shiftIsAdded) {
                                    totalShift.add(controller
                                            .leaveRequestDataList[i].shiftId ??
                                        "");
                                  }
                                ...
                                checkNet(context).then((value) {
                                  ...
                                  controller.addLeaveRequestModel.id = controller.selectedLeaveData.value.id??"";
                                  ...
                                  controller.addLeaveRequestModel
                                      .leaveCategoryId = strLeaveCategoryId;

                                  controller.addLeaveRequestModel.dataLeave =
                                      [];
                                  controller.addLeaveRequestModel.dataLeave
                                      ?.addAll(controller
                                          .leaveRequestDataList.value);

                                  controller.callEditLeaveAPI();
                                });
                              }, button_Color),
                            ),
                          ),
